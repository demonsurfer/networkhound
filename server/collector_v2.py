...
def main():
    cfg = dict(
        ...
        IDENT='collector',
        RHOST='houndbroker.threatstream.com',
        RPORT=10000,
        RCHANNEL='hound-community-v2.events',
        RIDENT='hound-server',
        RSECRET='hound-secret',
    ...
    try:
        ip = requests.get('https://myip.threatstream.com', headers={'User-Agent': 'hound-collector-v2'}).text.strip()
    except:
        ip = None
    hound_uuid = cfg['hound_UUID']
