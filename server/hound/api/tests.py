...
from hound import db
from hound.common.testcommon import houndTestCase
from hound.api.models import Sensor


class SensorTestCase(houndTestCase):

    def setUp(self):
        super(SensorTestCase, self).setUp()
        self.sensordata = dict(hostname='hound.test.sensor', name='Test Sensor')
