...
from hound import db, csrf
from hound.api import errors
from hound.api.models import (
        Sensor, Rule, DeployScript as Script,
        DeployScript, RuleSource)
from hound.api.decorators import deploy_auth, sensor_auth, token_auth
from hound.common.utils import error_response
from hound.common.clio import Clio
from hound.auth import current_user, login_required
...
def get_rules():
    ...
    if request.args.get('plaintext') in ['1', 'true']:
        ...
        resp.headers['Content-Disposition'] = "attachment; filename=hound.rules"
        return resp
    else:
