...
from hound.ui.utils import get_flag_ip, get_sensor_name
from hound.api.models import (
        Sensor, Rule, DeployScript as Script,
        RuleSource)
from hound.auth import login_required, current_user
from hound.auth.models import User, PasswdReset, ApiKey
from hound import db, hound
from hound.common.utils import (
        paginate_options, alchemy_pages, mongo_pages)
from hound.common.clio import Clio

ui = Blueprint('ui', __name__, url_prefix='/ui')
from hound import hound as app
...
def dashboard():
    ...
    #Top 5 Intrusion Detection Sensors with counts
