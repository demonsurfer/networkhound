...
cat > /opt/hpfeeds-logger/arcsight.json <<EOF
{
    ...
    "log_file": "/var/log/hound/hound-arcsight.log",
...
stdout_logfile=/var/log/hound/hpfeeds-logger-arcsight.log
stderr_logfile=/var/log/hound/hpfeeds-logger-arcsight.err
autostart=true
autorestart=true
startsecs=1
EOF
