...
mkdir -p /opt/suricata/etc/suricata/rules /opt/hound/rules/
...
# Register the sensor with hound server.
...
# hound.rules will be used as local.rules.
rm -f /opt/suricata/etc/suricata/rules/local.rules
ln -s /opt/hound/rules/hound-suricata.rules /opt/suricata/etc/suricata/rules/local.rules
...
mkdir -p /opt/hound/rules
rm -f /opt/hound/rules/hound.rules.tmp

echo "[`date`] Updating suricata signatures ..."
wget $server_url/static/hound.rules -O /opt/hound/rules/hound-suricata.rules.tmp && \
	mv /opt/hound/rules/hound-suricata.rules.tmp /opt/hound/rules/hound-suricata.rules && \
