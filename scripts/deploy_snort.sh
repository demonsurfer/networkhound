...
# Register the sensor with the hound server.
...
ln -s /opt/hound/rules/hound.rules /opt/snort/rules/local.rules
...
wget $server_url/static/hound.rules -O /opt/hound/rules/hound.rules.tmp && \
	mv /opt/hound/rules/hound.rules.tmp /opt/hound/rules/hound.rules && \
