...
mkdir -p /var/log/hound

cat > /etc/supervisor/conf.d/honeymap.conf <<EOF 
[program:honeymap]
command=/opt/honeymap/server/server
directory=/opt/honeymap
stdout_logfile=/var/log/hound/honeymap.log
stderr_logfile=/var/log/hound/honeymap.err
autostart=true
autorestart=true
startsecs=10
EOF
...
stdout_logfile=/var/log/hound/geoloc.log
stderr_logfile=/var/log/hound/geoloc.err
autostart=true
autorestart=true
startsecs=10
EOF
