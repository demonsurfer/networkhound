...
stdout_logfile=/var/log/hound/kibana.log
stderr_logfile=/var/log/hound/kibana.err
autostart=true
autorestart=true
startsecs=10
EOF
...
cat > /opt/logstash/hound-hpfeeds.conf <<EOF
...
command=/opt/logstash/bin/logstash -f hound-hpfeeds.conf
directory=/opt/logstash/
stdout_logfile=/var/log/hound/logstash-hpfeeds.log
stderr_logfile=/var/log/hound/logstash-hpfeeds.err
autostart=true
autorestart=true
startsecs=10
EOF
